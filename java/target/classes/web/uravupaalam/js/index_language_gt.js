			...
			else
			{
				...
				function getLanguageResources()
				{
					...
					/* Matrimony Page Start */
						...
						//ta['Search Registration'] = "பதிவை தேடுதல்"; en['Search Registration'] = "Search Registration";
						//ta['Search User'] = "பயனரை தேடு"; en['Search User'] = "Search User";
					...
					//localStorage.setItem("uravupaalamLanguage",JSON.stringify(resources));
