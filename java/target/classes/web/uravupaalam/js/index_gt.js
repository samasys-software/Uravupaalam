$(document).ready(function() 
{
	...
	// Country , State , District & Taluk Ends
		...
		function logout()
		{
			...
			//window.location.href = 'http://ec2-52-91-5-22.compute-1.amazonaws.com:8080/uravupaalam/index_gt.html';
		}
	...
	// Report screen starts
		...
		//{   
				...
				success: function(response) 
				{
					...
					else 
					{
						...
						{	
							...
							//user_userMap[userDetails.uId]=userDetails;
							...
							/*$("<a href='#' id='deactive" + counter + "'></a>").click(function()
							{
								$('#rowid"+counter+"').remove();
							});*/
			...
			$(document).delegate('.remove', 'click', function(evt) 
			{
					...
					//deleteuId=event.target.id;
					//var delId=deleteuId,uId;
